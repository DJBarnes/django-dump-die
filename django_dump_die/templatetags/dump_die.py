...
def dd_object(obj, skip=None, curr_iteration=0, curr_depth=0):
    """
    ...
    # In either case, just return the type and unique of the object for output.
    return {
        'type': type(obj).__name__,
        'unique': unique,
    }
